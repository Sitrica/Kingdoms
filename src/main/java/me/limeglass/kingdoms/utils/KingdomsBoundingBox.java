 ...
 * 
 * @author Spigot - Decompiled for usage in < 1.13
 */
@SerializableAs("KingdomsBoundingBox")
public class KingdomsBoundingBox implements Cloneable, ConfigurationSerializable {
	 ...
	 */
	public static KingdomsBoundingBox of(Location corner1, Location corner2) {
		...
		return new KingdomsBoundingBox(corner1.getX(), corner1.getY(), corner1.getZ(), corner2.getX(), corner2.getY(), corner2.getZ());
	}
	 ...
	 * @return the bounding box
	 */
	public static KingdomsBoundingBox of(Block block) {
		Validate.notNull(block, "Block is null!");
		return new KingdomsBoundingBox(block.getX(), block.getY(), block.getZ(), block.getX() + 1, block.getY() + 1, block.getZ() + 1);
	}
	 ...
	 */
	public KingdomsBoundingBox(double x1, double y1, double z1, double x2, double y2, double z2) {
	 ...
	 */
	public KingdomsBoundingBox resize(double x1, double y1, double z1, double x2, double y2, double z2) {
	 ...
	 */
	public KingdomsBoundingBox copy(KingdomsBoundingBox other) {
	 ...
	 */
	public KingdomsBoundingBox expand(double negativeX, double negativeY, double negativeZ, double positiveX, double positiveY, double positiveZ) {
	 ...
	 * @return this bounding box (now expanded)
	 */
	public KingdomsBoundingBox expand(double x, double y, double z) {
	 ...
	 * @return this bounding box (now expanded)
	 */
	public KingdomsBoundingBox expand(Vector expansion) {
	 ...
	 * @return this bounding box (now expanded)
	 */
	public KingdomsBoundingBox expand(double expansion) {
	 ...
	 * @return this bounding box (now expanded)
	 */
	public KingdomsBoundingBox expand(double dirX, double dirY, double dirZ, double expansion) {
	 ...
	 * @return this bounding box (now expanded)
	 */
	public KingdomsBoundingBox expand(Vector direction, double expansion) {
	 ...
	 * @return this bounding box (now expanded)
	 */
	public KingdomsBoundingBox expand(BlockFace blockFace, double expansion) {
	 ...
	 * @return this bounding box (now expanded)
	 */
	public KingdomsBoundingBox expandDirectional(double dirX, double dirY, double dirZ) {
	 ...
	 * @return this bounding box (now expanded)
	 */
	public KingdomsBoundingBox expandDirectional(Vector direction) {
	 ...
	 */
	public KingdomsBoundingBox union(double posX, double posY, double posZ) {
	 ...
	 * @see #contains(double, double, double)
	 */
	public KingdomsBoundingBox union(Vector position) {
	 ...
	 * @see #contains(double, double, double)
	 */
	public KingdomsBoundingBox union(Location position) {
		Validate.notNull(position, "Position is null!");
		return this.union(position.getX(), position.getY(), position.getZ());
	}
	 ...
	 * @return this bounding box (now expanded)
	 */
	public KingdomsBoundingBox union(KingdomsBoundingBox other) {
		Validate.notNull(other, "Other bounding box is null!");
	 ...
	 */
	public KingdomsBoundingBox intersection(KingdomsBoundingBox other) {
		Validate.notNull(other, "Other bounding box is null!");
	 ...
	 */
	public KingdomsBoundingBox shift(double shiftX, double shiftY, double shiftZ) {
	 ...
	 * @return this bounding box (now shifted)
	 */
	public KingdomsBoundingBox shift(Vector shift) {
	 ...
	 * @return this bounding box (now shifted)
	 */
	public KingdomsBoundingBox shift(Location shift) {
		Validate.notNull(shift, "Shift is null!");
		return this.shift(shift.getX(), shift.getY(), shift.getZ());
	}
	 ...
	 */
	public boolean overlaps(KingdomsBoundingBox other) {
		Validate.notNull(other, "Other bounding box is null!");
	 ...
	 * box
	 */
	public boolean contains(KingdomsBoundingBox other) {
		Validate.notNull(other, "Other bounding box is null!");
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof KingdomsBoundingBox)) return false;
		KingdomsBoundingBox other = (KingdomsBoundingBox) obj;
	...
	public String toString() {
		...
		builder.append("KingdomsBoundingBox [minX=");
		builder.append(minX);
		builder.append(", minY=");
		builder.append(minY);
		builder.append(", minZ=");
	 ...
	 */
	@Override
	public KingdomsBoundingBox clone() {
		try {
			return (KingdomsBoundingBox) super.clone();
	...
	public static KingdomsBoundingBox deserialize(Map<String, Object> args) {
		double minX = 0.0D;
		double minY = 0.0D;
		double minZ = 0.0D;
		double maxX = 0.0D;
		...
		return new KingdomsBoundingBox(minX, minY, minZ, maxX, maxY, maxZ);
	}
