...
import me.limeglass.kingdoms.placeholders.Placeholders;
...
public class ItemStackBuilder {
	...
	public ItemStackBuilder fromConfiguration(ConfigurationSection section) {
		if (this.section != null)
			Kingdoms.debugMessage("WARNING: You have already set the configuration section within the constructor, now you're setting with fromConfiguration() in an ItemStackBuilder");
		this.section = section;
		if (node != null)
